...
function setDropStatus(x) {
    $str = '<select name="status_name" class="form-control">';
    $str += '<option value="" >Select Status</option>';
    $str += '<option value="In Process" ' + (x == "In Process" ? "selected" : "") + '>In Process</option>';
    $str += '<option value="Pending" ' + (x == "Pending" ? "selected" : "") + '>Pending</option>';
    $str += '<option value="Completed" ' + (x == "Completed" ? "selected" : "") + '>Completed</option>';
    $str += '<option value="Cancel" ' + (x == "Cancel" ? "selected" : "") + '>Cancel</option>';
    $str += '</select>';
    return $str;
}
