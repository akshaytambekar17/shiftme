                            ...
                            <ul id="nav" class="nav navbar-nav" style="margin-top: 4%;margin-right: -24%;">
                              ...
                              <li>
                                    <div class="row" style="margin-top:20%;padding:5%;width:76%;">
                                        <div class="col-sm-1  hidden-xs" style="margin-right:-15%;margin-top:-37%;font-size: 20px;">
                                            <i style="color:#fff;" class="fa fa-phone-square"></i>
                                        </div>
                                        <div class="col-sm-11 col-xs-12" style="margin-top:-38%;margin-left: 10%;">
