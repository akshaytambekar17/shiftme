...
<!--<![endif]-->
    <head>
        ...
        <!--====== STYLESHEETS ======-->
        <link rel="stylesheet" href="<?= base_url(); ?>assets/themenew/css/normalize.css">
        <link rel="stylesheet" href="<?= base_url(); ?>assets/themenew/css/animate.css">
        <link rel="stylesheet" href="<?= base_url(); ?>assets/themenew/css/stellarnav.min.css">
        <link rel="stylesheet" href="<?= base_url(); ?>assets/themenew/css/owl.carousel.css">
        <link href="<?= base_url(); ?>assets/themenew/css/bootstrap.min.css" rel="stylesheet">
        <link href="<?= base_url(); ?>assets/themenew/css/font-awesome.min.css" rel="stylesheet">
