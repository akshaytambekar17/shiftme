            ...
            <div class="col-md-12">
                <div class="content-top-1">
                    <div class="pull-right">
                        <a href="<?= base_url()?>cms-page/add" class="btn btn-success" style="margin-bottom:-44px;margin-left: 11px;"><i class="fa fa-plus" aria-hidden="true"></i> Create CMS Pages</a>
                    </div>
                    <div class="table-responsive m-top90">
                        <table class="table table-striped table-bordered table-hover dataTables-example" id="cms_list">
                            <thead>
                                <tr>
                            ...
                            ?>
                                        <tr class="gradeX" id="order-<?= $value['id'] ?>">
                                            ...
                                            <td>
                                                <a href="<?= site_url('cms-page/update?id='.$value['id'])?>" class="btn btn-success view-invoice" data-id="<?= $value['id'] ?>" name="update-cms-page">Update</a>
                                                <a href="javascript:void(0)" class="btn btn-danger delete-cms-page" data-id="<?= $value['id'] ?>"  name="delete-slider" onclick="cmsPageDelete(this)">Delete</a><br>
                                            </td>
                                        </tr>
                                        <?php
                                    }
