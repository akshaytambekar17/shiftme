...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#getData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/Admin_controller/getServicesdata') ?>',
            ...
            "aoColumns": [{"bSortable": true, "mRender": checkbox}, {"mRender": null},{"mRender": null},{"mRender": setStatus},{"bSortable": false}],
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="border-radius: 0px">
                                ...
                                <span class="pull-right btn-group">
                                    <a href="<?php print base_url('admin/services-add'); ?>"><button type="button"  title="Add Services" class="btn btn-success"><i class="fa fa-plus-circle"></i></button></a>
