...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#getData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/Setting_controller/getQuoteData') ?>',
            ...
            "aoColumns": [{"bSortable": true, "mRender": checkbox}, {"mRender": null}, {"mRender": null}, {"mRender": null}, {"mRender": null}, {"mRender": null}, {"mRender": null}, {"mRender": null}],
                ...
                <div class="content-top-1 ">
                    <div class="table-responsive">
                        <form id="xform" onsubmit="return bulkDelete()">
                            ...
                            <input type="hidden" name="tab" value="qoute"/>
                            <div class="panel panel-default">
                                <div class="panel-heading" style="border-radius: 0px">
                                    <h3 class="panel-title pull-left">Shifting Quotes <small></small></h3>
