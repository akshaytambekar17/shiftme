                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('group_id', $gr, set_value('group_id'), 'id="group_id" class="form-control" placeholder="Select Group"');
                                            ?>
                                ...
                                <div class="row recruiter" style="display:none">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name='location' data-placeholder='location' class="form-control">
                                                    <option value="">Select Location</option>
                                                    <?php
                                                     foreach ($location as $r) {
                                                    echo "<option value='" . $r->city_name . "'>" . $r->city_name . "</option>";
                                                }
                                                    ?>
                                                </select>
