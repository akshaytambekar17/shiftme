...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#getData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/Admin_controller/gettermsData') ?>',
            ...
            "fnCreatedRow": function (nRow, aData, iDataIndex) {
                $('td:eq(2) > label', nRow).attr('onclick', "changeStatus('id'," + aData[0] + ",'home_slider')");
            },
                ...
                <div class="content-top-1 ">
                    <div class="table-responsive">
                        <form id="xform" onsubmit="return bulkDelete()">
                            ...
                            <input type="hidden" name="tab" value="terms_condition"/>
                        <div class="panel panel-default">
                            <div class="panel-heading" style="border-radius: 0px">
                                <h3 class="panel-title pull-left">Slider Image <small></small></h3>
                                <span class="pull-right btn-group">
                                    <!--<a href="<?php print base_url('admin/slider-images-add'); ?>"><button type="button"  title="Add Services" class="btn btn-success"><i class="fa fa-plus-circle"></i></button></a>-->
