            ...
            <div class="col-md-12">
                ...
                <div class="content-top-1 ">
                    <div class="table-responsive">
                        <form action="<?= site_url() ?>admin/labourServices-update/<?= $id ?>" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="">
                                    <label>Image</label>
                                    <input type="file" name="image" accept="image/*" class="file-loading file disable" value="<?php echo $labour->image; ?>" image="<?php echo $labour->image; ?>">
